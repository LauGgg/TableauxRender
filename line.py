...
class Line():
    def __init__(self, split, startPos, scale):
        ...
        if split:
            ...
            self.difference = scale * 25
            self.endPos1 = (self.startPos1[0] - self.difference, self.startPos1[1] + 40)
            self.endPos2 = (self.startPos2[0] + self.difference, self.startPos2[1] + 40)
        else:
            self.startPos = (startPos[0], startPos[1] + 6)
